...
function StatusBadge({ status }) {
  const map = {
    ...
    data_fetch_in_progress: { label: "Data Fetch In Progress", variant: "warning" },
    data_fetched: { label: "Data Fetched", variant: "orange" },
    credit_report_generation_in_progress: { label: "Generating Credit Report", variant: "warning" },
    credit_report_generated: { label: "Credit Report Generated", variant: "purple" },
    credit_report_generation_failed: { label: "Credit Report Failed", variant: "danger" },
    submitted: { label: "Submitted", variant: "info" },
    under_review: { label: "Under Review", variant: "warning" },
    in_progress: { label: "In Progress", variant: "warning" },
    model_executed: { label: "Models Run", variant: "purple" },
    pdf_generation_in_progress: { label: "Generating PDF", variant: "warning" },
    pdf_generated: { label: "PDF Ready", variant: "purple" },
    pdf_generation_failed: { label: "PDF Generation Failed", variant: "danger" },
